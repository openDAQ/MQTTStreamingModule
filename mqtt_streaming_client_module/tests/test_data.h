...
inline const std::vector<std::pair<int, uint64_t>> DATA_INT_INT_0 = {{2307, 1761567115},
                                                                     {4500, 1761567116},
                                                                     {198, 1761567117},
                                                                     {380, 1761567118},
                                                                     {500, 1761567119}};
inline const std::vector<std::pair<int, uint64_t>> DATA_INT_INT_1 = {{3, 1761567115000},
                                                                     {55358, 1761567116000},
                                                                     {9525, 1761567117000},
                                                                     {-454, 1761567118000},
                                                                     {454490, 1761567119000}};
inline const std::vector<std::pair<int, uint64_t>> DATA_INT_INT_2 = {{-7223, 1761567115000000},
